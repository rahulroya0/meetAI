...
import { ChatCompletionAudioParam, ChatCompletionMessageParam } from "openai/resources/index.mjs";
...
export async function POST(req: NextRequest) {
    ...
    if (eventType === "call.session_started") {
      ...
      `;
            ...
            if (!GPTResponseText) {
                return NextResponse.json({ error: "No responses from GPT" }, { status: 400 })
            }
