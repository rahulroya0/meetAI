...
const SignUpView = () => {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="text-muted-foreground *:[a]:hover:text-primary text-center text-xs text-balace *:a[]:underline *:[a]:underline-offset-4">
